...
async function getInitialForecast(): Promise<ForecastData> {
  try {
    ...
    return {
      ...
      kalshiProbabilities: forecast.kalshiProbabilities,
      polymarketProbabilities: forecast.polymarketProbabilities,
      polymarketDistribution: forecast.polymarketDistribution,
